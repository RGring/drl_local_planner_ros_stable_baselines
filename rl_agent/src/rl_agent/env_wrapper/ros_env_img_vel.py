...
class RosEnvImgVel(RosEnvAbs):
    ...
    def __init__(self, ns, state_collector, execution_mode, task_mode, state_size, observation_space, action_size, action_space, debug, goal_radius, wp_radius, robot_radius, reward_fnc):
        super(RosEnvImgVel, self).__init__(ns, state_collector, execution_mode, task_mode, state_size, observation_space, action_size, action_space, debug, goal_radius, wp_radius, robot_radius, reward_fnc)
