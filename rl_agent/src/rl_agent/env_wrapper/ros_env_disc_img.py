...
class RosEnvDiscImg(RosEnvImg):
    ...
    with discrente action space.
    '''
    def __init__(self, ns, state_collector, robot_radius, reward_fnc, debug, execution_mode="train", task_mode="static"):
        ...
        super(RosEnvDiscImg, self).__init__(ns, state_collector, execution_mode, task_mode, state_size,
                                            observation_space, action_size, action_space, debug, GOAL_RADIUS,
